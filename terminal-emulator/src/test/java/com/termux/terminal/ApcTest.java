...
public class ApcTest extends TerminalTestCase {
    ...
    public void testApcConsumed() {
        ...
        // This should not result in anything being written to the screen: The kitty graphics protocol
        // capability query is instead answered on stdin, which is checked by `KittyGraphicsTest`.
